...
gen.addEventListener("click", (e) => {
  ...
  if (fname.value == "" || lname.value == "" || date.value == "" || length.value == "" || course.value == "") {    
    ...
    document.getElementById("two").addEventListener("click", () => {
      ...
      document.getElementById('certificate').style.border = "14px solid rgb(0 74 173)"
    ...
    document.getElementById("three").addEventListener("click", () => {
      ...
      document.getElementById("one").addEventListener("click", () => {
        ...
        document.getElementById('certificate').style.border = "14px solid rgb(0, 100, 13)"
...
document.getElementById('normal2').addEventListener('click',()=>{
  ...
  document.querySelector('.description').style.bottom = "456px"
  document.querySelector('.sign').style.bottom = "375px"
})
...
document.getElementById('larger').addEventListener('click',()=>{
  ...
  document.querySelector('.description').style.bottom = "486px"
  document.querySelector('.sign').style.bottom = "406px"
})
...
document.getElementById('smaller').addEventListener('click',()=>{
  ...
  document.querySelector('.description').style.bottom = "426px"
  document.querySelector('.sign').style.bottom = "347px"
