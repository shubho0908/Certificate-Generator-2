...
gen.addEventListener("click", (e) => {
  ...
  document.getElementById("two").addEventListener("click", () => {
    ...
    document.getElementById("certificate").style.border = "14px solid rgb(6 47 100)";
  ...
  document.getElementById("three").addEventListener("click", () => {
    ...
    document.querySelector(".one").style.border = "none";
    document.getElementById("certificate").style.border = "14px solid rgb(6 92 43)";
  ...
  document.getElementById("one").addEventListener("click", () => {
    ...
    document.querySelector(".two").style.border = "none";
    document.querySelector(".three").style.border = "none";
    document.getElementById("certificate").style.border = "14px solid rgb(84 19 23)";
...
document.getElementById('normal2').addEventListener('click',()=>{
  ...
  document.querySelector('.description').style.bottom = '418px'
  document.querySelector('.sign').style.bottom = "328px"
})

document.getElementById('larger').addEventListener('click',()=>{
  document.getElementById('normal').innerText = "Large"
  document.querySelector('.name').style.fontSize = "90px"
  document.querySelector('.description').style.bottom = '428px'
  document.querySelector('.sign').style.bottom = "348px"
})
...
document.getElementById('smaller').addEventListener('click',()=>{
  ...
  document.querySelector('.description').style.bottom = '396px'
  document.querySelector('.sign').style.bottom = "304px"
})